"""Systeme de traduction bilingue FR/EN."""
import streamlit as st

TRANSLATIONS: dict[str, dict[str, str]] = {
    # --- App ---
    "app_title": {
        "fr": "RAG documents reglementaires",
        "en": "Regulatory Documents RAG",
    },
    "app_subtitle": {
        "fr": "Assistant intelligent pour l'analyse de documents reglementaires",
    ...
    # --- Chat page ---
    "chat_placeholder": {
        "fr": "Posez une question sur les documents charges...",
        "en": "Ask a question about uploaded documents...",
    },
    "chat_welcome_medical": {
        "fr": "Posez une question sur les documents medicaux charges. Exemples :\n"
        ...
        "en": "Ask a question about the uploaded medical documents. Examples:\n"
    ...
    "chat_welcome_statistique": {
        "fr": "Posez une question sur les documents statistiques charges. Exemples :\n"
        ...
        "en": "Ask a question about the uploaded statistical documents. Examples:\n"
    ...
    "no_documents": {
        "fr": "Aucun document indexe. Chargez des PDFs dans l'onglet 'Gestion des documents'.",
